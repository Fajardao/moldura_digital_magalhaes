#!/bin/bash
# Script de configuração para o sistema de moldura digital Magalhães

CONFIG_FILE="data.sh"
REQUIRED_PACKAGES="dialog git python3 python3-pip unclutter feh"
...
function get_files() {
    ...
    git clone "https://github.com/Fajardao/moldura_digital_magalhaes.git"
}
